...
{
    [Fact]
    [DisplayName("GenerateAsync should return valid response")]
    ...
    [Fact]
    [DisplayName("GenerateStreamAsync should stream tokens correctly")]
    ...
    [Fact]
    [DisplayName("GetModelInfoAsync should return correct model configuration info")]
    ...
    [Fact]
    [DisplayName("GenerateAsync with invalid request should throw exception")]
    public async Task GenerateAsync_WithInvalidRequest_ShouldThrow()
    {
        ...
        // Act & Assert
        var exception = await Should.ThrowAsync<ArgumentException>(async () => await provider.GenerateAsync(request));

        exception.Message.ShouldContain("Invalid request");
    }

    [Fact]
    [DisplayName("GenerateAsync with cancellation should handle correctly")]
    public async Task GenerateAsync_WithCancellation_ShouldCancel()
    {
        ...
        await Should.ThrowAsync<OperationCanceledException>(async () =>
            await provider.GenerateAsync(request, cts.Token));
    }

    [Fact]
    [DisplayName("GenerateAsync should capture and record all requests")]
    ...
    [Fact]
    [DisplayName("GenerateStreamAsync with cancellation should stop streaming")]
    ...
    [Fact]
    [DisplayName("Function calling provider should return function call correctly")]
