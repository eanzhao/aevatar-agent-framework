/*aevatar_tool
{
  "name": "weex_ai_account_leverage",
  "description": "WEEX AI Wars ACCOUNT API: POST /capi/v2/account/leverage (docs: https://www.weex.com/api-doc/contract/Account_API/AdjustLeverage)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "marginMode": {
        "type": "integer",
        "required": true,
        "description": "Margin mode \n 1: Cross Mode\n 3: Isolated Mode\n  The marginMode must be set to the account's current mode."
      },
      "longLeverage": {
        "type": "string",
        "required": true,
        "description": "Long position leverage  \n  In Cross Mode, must be identical to shortLeverage."
      },
      "shortLeverage": {
        "type": "string",
        "required": true,
        "description": "Short position leverage \n  In Cross Mode, must be identical to longLeverage."
      }
    }
  }
}
...
var required = new[] { "symbol", "marginMode", "longLeverage", "shortLeverage" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/account/leverage";
var method = "POST";

var allParams = new[] { "symbol", "marginMode", "longLeverage", "shortLeverage" };
