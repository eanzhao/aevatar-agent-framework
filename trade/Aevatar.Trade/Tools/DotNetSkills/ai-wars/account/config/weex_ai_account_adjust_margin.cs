/*aevatar_tool
{
  "name": "weex_ai_account_adjust_margin",
  "description": "WEEX AI Wars ACCOUNT API: POST /capi/v2/account/adjustMargin (docs: https://www.weex.com/api-doc/contract/Account_API/AdjustMargin)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      "coinId": {
        "type": "integer",
        "required": false,
        "description": "Collateral ID   Basic Crypto Information   \n Default is 2 (USDT)"
      },
      "isolatedPositionId": {
        "type": "integer",
        "required": true,
        "description": "Isolated margin position ID \nGet the isolatedPositionId"
      },
      "collateralAmount": {
        "type": "string",
        "required": true,
        "description": "Collateral amount \npositive means increase, and negative means decrease"
      }
    }
  }
}
...
var required = new[] { "isolatedPositionId", "collateralAmount" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/account/adjustMargin";
var method = "POST";

var allParams = new[] { "coinId", "isolatedPositionId", "collateralAmount" };
