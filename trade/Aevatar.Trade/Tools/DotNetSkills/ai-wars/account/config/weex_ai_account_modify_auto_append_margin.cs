/*aevatar_tool
{
  "name": "weex_ai_account_modify_auto_append_margin",
  "description": "WEEX AI Wars ACCOUNT API: POST /capi/v2/account/modifyAutoAppendMargin (docs: https://www.weex.com/api-doc/contract/Account_API/AutoAddMargin)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
var required = new[] { "positionId", "autoAppendMargin" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/account/modifyAutoAppendMargin";
var method = "POST";

var allParams = new[] { "positionId", "autoAppendMargin" };
