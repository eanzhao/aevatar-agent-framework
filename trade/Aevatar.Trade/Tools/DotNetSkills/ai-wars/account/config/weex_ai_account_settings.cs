/*aevatar_tool
{
  "name": "weex_ai_account_settings",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/settings (docs: https://www.weex.com/api-doc/contract/Account_API/GetSingleContractUserConfig)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      "symbol": {
        "type": "string",
        "required": false,
        "description": "Trading pair \nIf not filled in, all will be returned by default."
      }
    }
  }
}
...
const string requestPath = "/capi/v2/account/settings";
var method = "GET";
