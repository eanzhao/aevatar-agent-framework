/*aevatar_tool
{
  "name": "weex_ai_account_position_single_position",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/position/singlePosition (docs: https://www.weex.com/api-doc/contract/Account_API/GetSingleContractPosition)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/account/position/singlePosition";
var method = "GET";
