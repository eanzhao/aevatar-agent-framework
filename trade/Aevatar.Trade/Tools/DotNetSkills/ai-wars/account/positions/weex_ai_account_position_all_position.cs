/*aevatar_tool
{
  "name": "weex_ai_account_position_all_position",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/position/allPosition (docs: https://www.weex.com/api-doc/contract/Account_API/GetAllContractPositions)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/account/position/allPosition";
var method = "GET";
