/*aevatar_tool
{
  "name": "weex_ai_account_assets",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/assets (docs: https://www.weex.com/api-doc/contract/Account_API/GetAccountBalance)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/account/assets";
var method = "GET";
