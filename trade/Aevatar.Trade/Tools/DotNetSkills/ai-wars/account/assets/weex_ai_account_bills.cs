/*aevatar_tool
{
  "name": "weex_ai_account_bills",
  "description": "WEEX AI Wars ACCOUNT API: POST /capi/v2/account/bills (docs: https://www.weex.com/api-doc/contract/Account_API/GetContractBills)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/account/bills";
var method = "POST";
