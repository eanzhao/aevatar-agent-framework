/*aevatar_tool
{
  "name": "weex_ai_account_get_accounts",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/getAccounts (docs: https://www.weex.com/api-doc/contract/Account_API/AllContractAccountsInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/account/getAccounts";
var method = "GET";
