/*aevatar_tool
{
  "name": "weex_ai_account_get_account",
  "description": "WEEX AI Wars ACCOUNT API: GET /capi/v2/account/getAccount (docs: https://www.weex.com/api-doc/contract/Account_API/GetUserSingleAssetInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
var required = new[] { "coin" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/account/getAccount";
var method = "GET";

var allParams = new[] { "coin" };
