/*aevatar_tool
{
  "name": "weex_ai_order_cancel_plan",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/cancel_plan (docs: https://www.weex.com/api-doc/contract/Transaction_API/CancelPendingOrder)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
var required = new[] { "orderId" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/order/cancel_plan";
var method = "POST";

var allParams = new[] { "orderId" };
