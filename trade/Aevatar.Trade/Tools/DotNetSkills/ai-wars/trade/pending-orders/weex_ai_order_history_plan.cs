/*aevatar_tool
{
  "name": "weex_ai_order_history_plan",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/historyPlan (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetHistoricalPendingOrders)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "delegateType": {
        "type": "integer",
        "required": false,
        "description": "Order type: 1: Open long. 2: Open short. 3: Close long. 4: Close short."
      },
      "pageSize": {
        "type": "integer",
        "required": false,
        "description": "Items per page, ranging from 1 to 100, default is 100."
      }
    }
  }
}
...
const string requestPath = "/capi/v2/order/historyPlan";
var method = "GET";

var allParams = new[] { "symbol", "startTime", "endTime", "delegateType", "pageSize" };
