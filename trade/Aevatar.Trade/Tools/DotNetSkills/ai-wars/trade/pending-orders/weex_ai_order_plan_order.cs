/*aevatar_tool
{
  "name": "weex_ai_order_plan_order",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/plan_order (docs: https://www.weex.com/api-doc/contract/Transaction_API/PlacePendingOrder)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "client_oid": {
        "type": "string",
        "required": true,
        "description": "Custom order ID (≤40 chars, no special characters), must be unique in maker ordersIf left empty, the system will automatically assign a value."
      },
      "size": {
        "type": "string",
        "required": true,
        "description": "Order quantity in lots (cannot be zero or negative)"
      },
      "type": {
        "type": "string",
        "required": true,
...
var required = new[] { "symbol", "client_oid", "size", "type", "match_type", "execute_price", "trigger_price" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/order/plan_order";
var method = "POST";

var allParams = new[] { "symbol", "client_oid", "size", "type", "match_type", "execute_price", "trigger_price", "marginMode" };
