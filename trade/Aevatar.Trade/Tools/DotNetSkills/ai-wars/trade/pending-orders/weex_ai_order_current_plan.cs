/*aevatar_tool
{
  "name": "weex_ai_order_current_plan",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/currentPlan (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetCurrentPendingOrders)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "orderId": {
        "type": "integer",
        "required": false,
        "description": "OrderId  (The filter will be bypassed if invalid characters are input.)"
      },
      "startTime": {
        "type": "integer",
        "required": false,
        "description": "The record start time for the query \n Unix millisecond timestamp"
      },
      "endTime": {
        "type": "integer",
        "required": false,
        "description": "The end time of the record for the query \n Unix millisecond timestamp"
      },
      "limit": {
        "type": "integer",
        "required": false,
        "description": "Limit number default 100 max 100"
      },
      "page": {
        "type": "integer",
        "required": false,
...
const string requestPath = "/capi/v2/order/currentPlan";
var method = "GET";

var allParams = new[] { "symbol", "orderId", "startTime", "endTime", "limit", "page" };
