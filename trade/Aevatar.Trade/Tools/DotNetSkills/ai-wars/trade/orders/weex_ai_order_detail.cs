/*aevatar_tool
{
  "name": "weex_ai_order_detail",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/detail (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetSingleOrderInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/order/detail";
var method = "GET";
