/*aevatar_tool
{
  "name": "weex_ai_order_cancel_order",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/cancel_order (docs: https://www.weex.com/api-doc/contract/Transaction_API/CancelOrder)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/order/cancel_order";
var method = "POST";

var allParams = new[] { "orderId", "clientOid" };
