/*aevatar_tool
{
  "name": "weex_ai_order_current",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/current (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetCurrentOrderStatus)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/order/current";
var method = "GET";
