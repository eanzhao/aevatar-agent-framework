/*aevatar_tool
{
  "name": "weex_ai_order_fills",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/fills (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetTradeDetails)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/order/fills";
var method = "GET";

var allParams = new[] { "symbol", "orderId", "startTime", "endTime", "limit" };
