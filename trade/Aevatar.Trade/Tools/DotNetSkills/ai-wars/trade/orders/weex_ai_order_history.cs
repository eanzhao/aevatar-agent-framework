/*aevatar_tool
{
  "name": "weex_ai_order_history",
  "description": "WEEX AI Wars TRADE API: GET /capi/v2/order/history (docs: https://www.weex.com/api-doc/contract/Transaction_API/GetOrderHistory)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "createDate": {
        "type": "integer",
        "required": false,
        "description": "Creation time (must be ≤ 90 and cannot be negative)\n Unix millisecond timestamp"
      }
    }
  }
}
...
const string requestPath = "/capi/v2/order/history";
var method = "GET";

var allParams = new[] { "symbol", "pageSize", "createDate" };
