/*aevatar_tool
{
  "name": "weex_ai_order_close_positions",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/closePositions (docs: https://www.weex.com/api-doc/contract/Transaction_API/ClosePositions)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      "symbol": {
        "type": "string",
        "required": false,
        "description": "Trading pair. If not provided, all positions will be closed at market price"
      }
    }
  }
}
...
const string requestPath = "/capi/v2/order/closePositions";
var method = "POST";
