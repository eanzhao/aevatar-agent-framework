/*aevatar_tool
{
  "name": "weex_ai_order_place_tp_sl_order",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/placeTpSlOrder (docs: https://www.weex.com/api-doc/contract/Transaction_API/PlaceTpSlOrder)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "executePrice": {
        "type": "string",
        "required": false,
        "description": "Execution price. If not provided or set to 0, market price will be used. Value > 0 means limit price"
      },
      "size": {
        "type": "string",
        "required": true,
...
var required = new[] { "symbol", "clientOrderId", "planType", "triggerPrice", "size", "positionSide" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/order/placeTpSlOrder";
var method = "POST";

var allParams = new[] { "symbol", "clientOrderId", "planType", "triggerPrice", "executePrice", "size", "positionSide", "marginMode" };
