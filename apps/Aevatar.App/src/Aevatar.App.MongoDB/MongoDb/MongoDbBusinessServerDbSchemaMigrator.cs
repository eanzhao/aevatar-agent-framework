...
public class MongoDbAppDbSchemaMigrator : IAppDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAppDbSchemaMigrator(IServiceProvider serviceProvider)
    {
