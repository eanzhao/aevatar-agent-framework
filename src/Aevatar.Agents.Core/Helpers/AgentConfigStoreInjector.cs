...
/// Injects IConfigStore into Agent instances after creation
/// </summary>
public static class AgentConfigStoreInjector
{
    /// <summary>
    ...
    private static PropertyInfo? FindConfigurationStoreProperty(Type agentType, Type configType)
    {
        ...
        foreach (var prop in properties)
        {
            if (prop.Name == "ConfigStore" &&
                ...
                prop.PropertyType.GetGenericTypeDefinition() == typeof(IConfigStore<>))
            {
                return prop;
            }
        }
    ...
    public static void InjectConfigStore(IGAgent agent, IServiceProvider serviceProvider)
    {
        ...
        while (baseType != null && baseType != typeof(object))
        {
                ...
                baseType.GetGenericTypeDefinition() == typeof(GAgentBase<,>))
            {
                ...
                if (genericArgs.Length == 2)
                {
                    ...
                    var configStoreType = typeof(IConfigStore<>).MakeGenericType(configType);
