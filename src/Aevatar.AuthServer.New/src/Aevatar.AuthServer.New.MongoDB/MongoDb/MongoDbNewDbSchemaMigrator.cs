...
using Aevatar.AuthServer.New.Data;
using Volo.Abp.Data;
...
public class MongoDbNewDbSchemaMigrator : INewDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbNewDbSchemaMigrator(IServiceProvider serviceProvider)
    {
