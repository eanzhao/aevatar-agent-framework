...
```bash
cd src/Aevatar.AuthServer.New/src/Aevatar.AuthServer.New.DbMigrator
dotnet run
```
...
### 2. 启动 AuthServer
```bash
cd src/Aevatar.AuthServer.New/src/Aevatar.AuthServer.New.Web
dotnet run
```
