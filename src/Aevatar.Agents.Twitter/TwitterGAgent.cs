...
public class TwitterGAgent : GAgentBase<TwitterGAgentState>
{
    ...
    public TwitterGAgent() : base()
    {
    }

    public TwitterGAgent(Guid id, ILogger<TwitterGAgent>? logger = null) : base(id, logger)
    {
    }

    public TwitterGAgent(Guid id, ITwitterProvider twitterProvider, ILogger<TwitterGAgent>? logger = null) 
        : base(id, logger)
    {
    ...
    {
        Logger.LogInformation("TwitterGAgent {Id} received reply to tweet {TweetId}: {Text}", Id, evt.TweetId, evt.Text);
    ...
    {
        Logger.LogInformation("TwitterGAgent {Id} configuring with consumer key: {ConsumerKey}", Id, configuration.ConsumerKey);
