...
using Aevatar.BusinessServer.Data;
using Volo.Abp.Data;
...
public class MongoDbBusinessServerDbSchemaMigrator : IBusinessServerDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbBusinessServerDbSchemaMigrator(IServiceProvider serviceProvider)
    {
