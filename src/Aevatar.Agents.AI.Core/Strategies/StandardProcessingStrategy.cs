...
public class StandardProcessingStrategy : IAevatarAIProcessingStrategy
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (response.AevatarFunctionCall != null && dependencies.ToolManager != null)
            {
                ...
                var parameters = System.Text.Json.JsonSerializer.Deserialize<System.Collections.Generic.Dictionary<string, object>>(
                    response.AevatarFunctionCall.Arguments) ?? new System.Collections.Generic.Dictionary<string, object>();
                ...
                if (dependencies.PublishEventCallback != null && toolResult.Success)
                {
                    var toolEvent = new AevatarToolExecutedEvent
                    {
                        ToolName = response.AevatarFunctionCall.Name,
                        Result = toolResult.Result?.ToString() ?? "No result",
    ...
    private Aevatar.Agents.AI.AevatarChatRole ParseChatRole(string roleString)
    {
        ...
        {
            "system" => Aevatar.Agents.AI.AevatarChatRole.System,
            "user" => Aevatar.Agents.AI.AevatarChatRole.User,
            "assistant" => Aevatar.Agents.AI.AevatarChatRole.Assistant,
            "function" => Aevatar.Agents.AI.AevatarChatRole.Function,
            _ => Aevatar.Agents.AI.AevatarChatRole.User
        };
    }
}